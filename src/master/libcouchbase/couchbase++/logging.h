...
namespace Couchbase
{
  ...
  public:
    ...
    virtual void log(const Meta& message, int severity, const char* fmt,
                     va_list ap) = 0;
  ...
  public:
    ...
    virtual void log(const Meta& meta, int severity, const char* fmt,
                     va_list ap) override
    {
      va_list apc;
      va_copy(apc, ap);
  ...
  extern "C" {
  static void Internal::logcb(lcb_logprocs_st* procs, unsigned int iid,
                              const char* subsys,
                              int severity, const char* srcfile, int srcline,
